...
/*
void wave_read_8bit_mono(MONO_PCM* pcm, char* file_name)//音の読み込み用関数
{
    FILE* fp;
...
void wave_write_8bit_mono(MONO_PCM* pcm, char* file_name)//音の書き込み用関数
{
    FILE* fp;
    char riff_chunk_ID[4];
    long riff_chunk_size;
...
void wave_read_8bit_stereo(STEREO_PCM* pcm, char* file_name)//ステレオ読み込み
{
    FILE* fp;
    char riff_chunk_ID[4];
    long riff_chunk_size;
...
void wave_write_8bit_stereo(STEREO_PCM* pcm, char* file_name)//ステレオ書き込み
{
    FILE* fp;
    char riff_chunk_ID[4];
    long riff_chunk_size;
